...
?>
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="img/uyeResimleri/<?php echo $profilSonuc->uyeResimurl;?>" class="user-image" alt="User Image">
                  <span class="hidden-xs"><?php echo $_SESSION['adsoyad']; ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                                 <img src="img/uyeResimleri/<?php echo $profilSonuc->uyeResimurl;?>" class="img-circle" alt="User Image">
                    <p>
...
?>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="adminindex.php?s=icerik.php">
                <i class="fa fa-dashboard"></i> <span>İçerik Yönetimi</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              
            </li>
            <li class="treeview">
              <a href="adminindex.php?s=seokelimeler.php">
                <i class="fa fa-key" aria-hidden="true"></i>

                <span>SeoKelimeler Yönetimi</span>
            ...
            <li class="treeview">
              <a href="adminindex.php?s=yorum.php">
            ...
            <li class="treeview">
              <a href="adminindex.php?s=iletisima.php">
            ...
            <li class="treeview">
              <a href="adminindex.php?s=kullanici.php">
...
<span>Kullanıcı Yönetimi</span>               
        ...
        <!-- /.sidebar -->
		  ...
		  <?php  include("adminfonksiyonlar/if.php");?>
